...
<body>
                ...
                <div class="row bg-dark d-none d-lg-flex">
                    ...
                    <div class="col-lg-5 text-right">
                        <div class="d-inline-flex align-items-center pr-2">
                            <a class="text-primary p-2" href="https://facebook.com/ilosrim">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a class="text-primary p-2" href="https://x.com/ilosrim">
                                <i class="fab fa-twitter"></i>
                            </a>
                            <a class="text-primary p-2" href="https://linkedin.com/in/ilosrim">
                                <i class="fab fa-linkedin-in"></i>
                            </a>
                            <a class="text-primary p-2" href="https://instagram.com/ilosrim">
                                <i class="fab fa-instagram"></i>
                            </a>
                            <a class="text-primary p-2" href="https://youtube.com/@ilosrim">
    ...
    <div class="container-fluid bg-dark text-white mt-5 py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <h4 class="font-weight-semi-bold text-primary mb-4">Aloqaga chiqish</h4>
                <p><i class="fa fa-map-marker-alt text-primary mr-2"></i>123 Street, New York, USA</p>
                <p><i class="fa fa-phone-alt text-primary mr-2"></i>+012 345 67890</p>
                <p><i class="fa fa-envelope text-primary mr-2"></i>info@example.com</p>
                <div class="d-flex justify-content-start mt-4">
                    <a class="btn btn-light btn-social mr-2 d-flex justify-content-center align-items-center"
                        href="https://x.com/ilosrim"><i class="fab fa-twitter"></i></a>
                    <a class="btn btn-light btn-social mr-2 d-flex justify-content-center align-items-center"
                        href="https://facebook.com/ilosrim"><i class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-light btn-social mr-2 d-flex justify-content-center align-items-center"
                        href="https://linkedin.com/in/ilosrim"><i class="fab fa-linkedin-in"></i></a>
                    <a class="btn btn-light btn-social d-flex justify-content-center align-items-center"
                        href="https://instagram.com/ilosrim"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <h4 class="font-weight-semi-bold text-primary mb-4">Tezkor havolalar</h4>
                <div class="d-flex flex-column justify-content-start">
                    <a class="text-white mb-2" href="/"><i class="fa fa-angle-right mr-2"></i>Bosh sahifa</a>
                    <a class="text-white mb-2" href="{{ route('about') }}"><i class="fa fa-angle-right mr-2"></i>Biz
                        haqimizda</a>
                    <a class="text-white mb-2" href="{{ route('service') }}"><i
                            class="fa fa-angle-right mr-2"></i>Bizning hizmatlar</a>
                    <a class="text-white mb-2" href="{{ route('project') }}"><i
                            class="fa fa-angle-right mr-2"></i>Bizning loyihalar</a>
                    <a class="text-white" href="{{ route('contact') }}"><i
                            class="fa fa-angle-right mr-2"></i>Kontakt</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <h4 class="font-weight-semi-bold text-primary mb-4">Yangiliklar</h4>
                ...
                <div class="w-100">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-primary px-4">Obuna bo'ling</button>
                        </div>
                    </div>
                </div>
            </div>
